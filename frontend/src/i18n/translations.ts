...
const en = {
  ...
  "tracker.changePassword": "Change edit password",
  "tracker.setPassword": "Set edit password",
  "tracker.changePasswordTitle": "Change edit password",
  "tracker.setPasswordTitle": "Set edit password",
  "tracker.changePasswordIntro":
    "Enter a new edit password twice, or remove the password to let anyone edit this tracker.",
  "tracker.newPasswordPlaceholder": "New edit password",
  "tracker.confirmPasswordPlaceholder": "Repeat new edit password",
  "tracker.savePassword": "Save password",
  "tracker.savingPassword": "Saving…",
  "tracker.removePassword": "Remove password",
  "tracker.confirmRemovePassword":
    "Remove the edit password? Everyone with the link will be able to edit this tracker.",
  "tracker.passwordMismatch": "The passwords do not match.",
  "tracker.passwordEmpty": "Please enter a new password.",
  "tracker.passwordChangeFailed": "Failed to change the edit password.",
...
const de: Record<TranslationKey, string> = {
  ...
  "tracker.changePassword": "Bearbeitungspasswort ändern",
  "tracker.setPassword": "Bearbeitungspasswort festlegen",
  "tracker.changePasswordTitle": "Bearbeitungspasswort ändern",
  "tracker.setPasswordTitle": "Bearbeitungspasswort festlegen",
  "tracker.changePasswordIntro":
    "Gib ein neues Bearbeitungspasswort zweimal ein oder entferne das Passwort, damit alle diesen Tracker bearbeiten können.",
  "tracker.newPasswordPlaceholder": "Neues Bearbeitungspasswort",
  "tracker.confirmPasswordPlaceholder": "Neues Bearbeitungspasswort wiederholen",
  "tracker.savePassword": "Passwort speichern",
  "tracker.savingPassword": "Wird gespeichert…",
  "tracker.removePassword": "Passwort entfernen",
  "tracker.confirmRemovePassword":
    "Bearbeitungspasswort entfernen? Alle mit dem Link können diesen Tracker dann bearbeiten.",
  "tracker.passwordMismatch": "Die Passwörter stimmen nicht überein.",
  "tracker.passwordEmpty": "Bitte gib ein neues Passwort ein.",
  "tracker.passwordChangeFailed":
    "Bearbeitungspasswort konnte nicht geändert werden.",
...
const cs: Record<TranslationKey, string> = {
  ...
  "tracker.changePassword": "Změnit heslo pro úpravy",
  "tracker.setPassword": "Nastavit heslo pro úpravy",
  "tracker.changePasswordTitle": "Změnit heslo pro úpravy",
  "tracker.setPasswordTitle": "Nastavit heslo pro úpravy",
  "tracker.changePasswordIntro":
    "Zadejte dvakrát nové heslo pro úpravy, nebo heslo odstraňte, aby mohl toto sledování upravovat kdokoli.",
  "tracker.newPasswordPlaceholder": "Nové heslo pro úpravy",
  "tracker.confirmPasswordPlaceholder": "Zopakujte nové heslo pro úpravy",
  "tracker.savePassword": "Uložit heslo",
  "tracker.savingPassword": "Ukládání…",
  "tracker.removePassword": "Odstranit heslo",
  "tracker.confirmRemovePassword":
    "Odstranit heslo pro úpravy? Sledování pak bude moci upravit každý, kdo má odkaz.",
  "tracker.passwordMismatch": "Hesla se neshodují.",
  "tracker.passwordEmpty": "Zadejte prosím nové heslo.",
  "tracker.passwordChangeFailed": "Heslo pro úpravy se nepodařilo změnit.",
